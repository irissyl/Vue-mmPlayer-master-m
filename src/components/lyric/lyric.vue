  ...
  <div>
    ...
    <dl class="music-info">
      ...
      <template v-if="currentMusic.id">
        <dd style="color: #ffffff99;">歌曲名：{{ currentMusic.name }}</dd>
        <dd style="color: #ffffff99;">歌手名：{{ currentMusic.singer }}</dd>
        <dd style="color: #ffffff99;">专辑名：{{ currentMusic.album }}</dd>
      </template>
      <template v-else>
        <dd style="color: #ffffff99;">深藏blue音乐播放器</dd>
      </template>
    </dl>
    <!--歌词-->
    <div ref="musicLyric" class="music-lyric">
      <div class="music-lyric-items" :style="lyricTop" style="color: #ffffff99;">
        <p v-if="!currentMusic.id" style="color: #ffffff99;">还没有播放音乐哦！</p>
        <p v-else-if="nolyric" style="color: #ffffff99;">暂无歌词！</p>
        ...
        <p v-else style="color: #ffffff99;">歌词加载失败！</p>
      </div>
    </div>
  </div>
</template>
